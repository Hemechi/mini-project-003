  ...
  return (
    <>
      ...
      <aside id="logo-sidebar"
        className={`fixed lg:sticky left-0 z-40 lg:z-0 w-64 sm:h-96 lg:h-screen transition-transform ${isSidebarOpen ? '' : '-translate-x-full lg:translate-x-0'
          }`}
        aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link href="/dashboard/create" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
